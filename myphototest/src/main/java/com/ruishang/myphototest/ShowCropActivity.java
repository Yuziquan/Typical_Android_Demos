...
import com.ruishang.myphototest.utils.Utils;

public class ShowCropActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ShowCropActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("--", "LANGUAGE_PATH:" + LANGUAGE_PATH + "------LANGUAGE:" + LANGUAGE);
