...
public class MainActivity extends BaseActivity
{
    ...
    private void initView()
    {
        ...
        Glide.with(this).load(R.mipmap.head).apply(options.circleCrop()).into(iv_head);
        Glide.with(this).load(R.mipmap.head).apply(options.circleCrop()).into(toolbar_avatar);
    }
